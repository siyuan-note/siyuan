...
7. **Git:** Do not run `git commit` / `git push` unless explicitly asked; when writing commit messages, follow the style of recent commits (gitmoji prefix + subject + issue/PR ref)
