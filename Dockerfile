...
RUN apt-get update -y &&         apt-get install -y --no-install-recommends           dbus dbus-user-session           curl wget tar gzip ca-certificates gnupg           xvfb fluxbox xdg-utils           libnss3 libasound2 libxss1 libatk-bridge2.0-0 libgtk-3-0           libx11-xcb1 libxcb-dri3-0 libdrm2 libgbm1 libxshmfence1 libegl1           libxcomposite1 libxdamage1 libxrandr2 libu2f-udev &&         mkdir -p /run/dbus &&         rm -rf /var/lib/apt/lists/*
