...
- **Her çalışma alanına tek yazıcı:** Kopya sayısını artırma veya aynı çalışma alanını çalışan başka bir örneğe bağlama; ReadWriteMany depolama da bunu güvenli hâle getirmez. Chart, `Recreate` stratejisiyle yeni örneği başlatmadan önce eskisini durdurur; bu nedenle yükseltmeler sırasında hizmet kesintisi olur.
