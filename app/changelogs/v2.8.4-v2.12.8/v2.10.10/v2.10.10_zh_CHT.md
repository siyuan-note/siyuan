...
* [為塊引用右鍵選單新增 `開啟反向連結` 和 `開啟關係圖`](https://github.com/siyuan-note/siyuan/issues/9383)
...
* [新增 `複製塊引超連結（Markdown）` 快捷鍵](https://github.com/siyuan-note/siyuan/issues/9392)
* [改進行動端文字選擇後的工具列位置](https://github.com/siyuan-note/siyuan/issues/9393)
* [改進程式碼塊語言預設選擇](https://github.com/siyuan-note/siyuan/issues/9396)
...
* [編輯器中的塊顯示資料庫角標](https://github.com/siyuan-note/siyuan/issues/8894)
