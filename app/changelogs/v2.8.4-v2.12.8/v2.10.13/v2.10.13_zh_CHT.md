...
* [改進匯出 PDF 時程式碼塊行號顯示](https://github.com/siyuan-note/siyuan/issues/9471)
...
* [支援聚焦狀態下 `跳到父級的下一個塊`](https://github.com/siyuan-note/siyuan/issues/9527)
* [改進塊屬性為空時自動刪除屬性](https://github.com/siyuan-note/siyuan/issues/9529)
...
* [支援在 HTML 塊中進行搜尋替換](https://github.com/siyuan-note/siyuan/issues/9539)
...
* [將標題塊轉換為文件時不顯示標題下塊](https://github.com/siyuan-note/siyuan/issues/9512)
