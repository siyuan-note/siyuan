...
* [支援在搜尋結果清單中使用一些塊級快捷鍵](https://github.com/siyuan-note/siyuan/issues/9548)
* [支援 GFScript 程式碼塊高亮](https://github.com/siyuan-note/siyuan/issues/9558)
...
* [維護資料庫塊與資料庫儲存之間的關聯關係](https://github.com/siyuan-note/siyuan/issues/9496)
