...
* [從嵌入塊中開啟文件後不應該顯示 `退出聚焦`](https://github.com/siyuan-note/siyuan/issues/9254)
* [Ctrl+滾輪 調整字號後程式碼塊行號錯位](https://github.com/siyuan-note/siyuan/issues/9260)
* [調整 外觀 - 字號 後程式碼塊行號錯位](https://github.com/siyuan-note/siyuan/issues/9267)

### 開發者

* [屬性檢視新增資源類型欄位](https://github.com/siyuan-note/siyuan/issues/8895)
* [資料庫插入塊時增加動畫](https://github.com/siyuan-note/siyuan/issues/9092)
* [改進文件塊標選單中的插件選單項目位置](https://github.com/siyuan-note/siyuan/pull/9225)
