...
* [查詢嵌入塊支援執行 JavaScript](https://github.com/siyuan-note/siyuan/issues/9648)
...
* [只有使用 `<div>` 包裹的 HTML 程式碼才會被解析為 HTML 塊](https://github.com/siyuan-note/siyuan/issues/9758)

### 修復缺陷

* [使用 `#` 輸入標題塊後無法觸發斜桿選單](https://github.com/siyuan-note/siyuan/issues/9022)
* [行級備註無法被搜尋](https://github.com/siyuan-note/siyuan/issues/9710)
* [在程式碼塊最後一行三擊時無法選取](https://github.com/siyuan-note/siyuan/issues/9714)
...
* [Windows 端自訂插入程式碼塊快速鍵後異常](https://github.com/siyuan-note/siyuan/issues/9735)
* [如果內容以`<foo>`開頭，Enter 鍵無法建立新塊](https://github.com/siyuan-note/siyuan/issues/9755)
