...
* [改進 `//!js` 查詢嵌入塊結果排序](https://github.com/siyuan-note/siyuan/issues/9977)
...
* [在嵌入塊中的圖片未能上傳社群](https://github.com/siyuan-note/siyuan/issues/10042)
...
* [資料庫表格視圖主鍵列支援 `[[` 綁定塊](https://github.com/siyuan-note/siyuan/issues/9983)
