...
* [移除嵌入塊中的圖片圖示選單](https://github.com/siyuan-note/siyuan/issues/10097)
...
* [標題塊下方塊的父塊欄位計算不正確](https://github.com/siyuan-note/siyuan/issues/9869)
...
* [資料庫塊支援匯出 CSV](https://github.com/siyuan-note/siyuan/issues/10072)
