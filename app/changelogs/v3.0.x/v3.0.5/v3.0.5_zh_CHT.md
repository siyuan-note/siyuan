...
* [搜尋類型過濾支援音訊、視訊、掛飾和 IFrame 塊](https://github.com/siyuan-note/siyuan/issues/10645)
* [改進聚焦塊匯出時引用轉換註腳](https://github.com/siyuan-note/siyuan/issues/10647)
...
* [塊 `複製純文字` 後遊標遺失](https://github.com/siyuan-note/siyuan/issues/10694)
...
* [無法搜尋替換程式碼塊中的 `{{foo}}`](https://github.com/siyuan-note/siyuan/issues/10706)
* [行尾元素後軟換行會遺失換行](https://github.com/siyuan-note/siyuan/issues/10718)
* [md 程式碼塊中剪切時將 `<foo>` 誤轉換為 `&lt;foo&gt;`](https://github.com/siyuan-note/siyuan/issues/10722)
