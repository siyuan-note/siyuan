...
* [資料庫主鍵支援解綁塊](https://github.com/siyuan-note/siyuan/issues/10849)
* [改進閃卡選單](https://github.com/siyuan-note/siyuan/issues/10857)
* [從資料庫刪除行後刷新對應的總和](https://github.com/siyuan-note/siyuan/issues/10858)
* [點選塊上標圖示時自動校驗資料庫名稱](https://github.com/siyuan-note/siyuan/issues/10861)
...
* [支援新增資料庫塊](https://github.com/siyuan-note/siyuan/issues/10876)
* [改進資料庫表格視圖選取儲存格內容的互動](https://github.com/siyuan-note/siyuan/issues/10877)
* [改進 iframe 塊的選擇](https://github.com/siyuan-note/siyuan/issues/10879)
* [改進資料庫塊引用錨文本顯示](https://github.com/siyuan-note/siyuan/issues/10880)
...
* [改進麵包屑中的資料庫塊文字](https://github.com/siyuan-note/siyuan/issues/10891)
...
* [支援拖曳掛件塊](https://github.com/siyuan-note/siyuan/issues/10900)
...
* [資料庫塊包含在文件字數統計中](https://github.com/siyuan-note/siyuan/issues/10918)
* [改進資料庫表格檢視中的列選單的刪除和複製](https://github.com/siyuan-note/siyuan/issues/10920)
* [刪除父塊時刪除綁定到子塊的資料庫行](https://github.com/siyuan-note/siyuan/issues/10923)
...
* [建立新的塊可能會導致頁籤關閉](https://github.com/siyuan-note/siyuan/issues/10851)
