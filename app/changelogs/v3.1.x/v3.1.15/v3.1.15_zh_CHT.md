...
* [改進導出塊引用](https://github.com/siyuan-note/siyuan/issues/13331)
* [改進搜尋高亮](https://github.com/siyuan-note/siyuan/issues/13343)
* [改進範本搜尋](https://github.com/siyuan-note/siyuan/issues/13348)
* [改進匯出為 PDF 時的程式碼塊分頁](https://github.com/siyuan-note/siyuan/issues/13349)
* [改進 HTML 剪藏](https://github.com/siyuan-note/siyuan/issues/13355)
* [改進系統字體載入](https://github.com/siyuan-note/siyuan/issues/13356)
* [產生包含 ' 字元的塊引用時導致奇怪的行為](https://github.com/siyuan-note/siyuan/issues/13358)
* [簡化搜尋結果中的文件塊路徑](https://github.com/siyuan-note/siyuan/issues/13364)
* [瀏覽器剪藏擴充功能加入了一些實驗性功能](https://github.com/siyuan-note/siyuan/issues/13366)
* [屬性面板 - 資料庫支援移除目前塊](https://github.com/siyuan-note/siyuan/issues/13375)
...
* [改進選擇塊或表格儲存格後 `Backspace` `Delete` `Tab` `Shift+Tab` 的操作](https://github.com/siyuan-note/siyuan/issues/13027)
