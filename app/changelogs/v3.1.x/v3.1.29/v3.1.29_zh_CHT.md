...
* [支援透過快捷鍵切換程式碼塊語言](https://github.com/siyuan-note/siyuan/issues/14126)
...
* [`複製` 後選取塊](https://github.com/siyuan-note/siyuan/issues/14567)
* [支援配置是否匯出行級備註](https://github.com/siyuan-note/siyuan/issues/14605)
* [改進貼上超連結和塊引用錨文本](https://github.com/siyuan-note/siyuan/issues/14625)
...
* [改進滑鼠選擇程式碼塊](https://github.com/siyuan-note/siyuan/pull/14646)
* [日記快捷鍵自動重設為預設值](https://github.com/siyuan-note/siyuan/issues/14652)
* [改進行動端塊跳回動畫](https://github.com/siyuan-note/siyuan/issues/14655)
* [改進瀏覽器剪藏擴充功能](https://github.com/siyuan-note/siyuan/issues/14669)
* [改進換行後嵌入塊的渲染](https://github.com/siyuan-note/siyuan/issues/14672)
* [改進嵌入塊中程式碼塊的互動](https://github.com/siyuan-note/siyuan/issues/14678)
...
* [支援匯出 PDF 時塊內分頁](https://github.com/siyuan-note/siyuan/issues/14702)
* [改進段落開頭行級元素前的 Tab 字元輸入](https://github.com/siyuan-note/siyuan/issues/14703)
* [當塊引用錨文本僅包含空白字元時設定為靜態錨文本 ID](https://github.com/siyuan-note/siyuan/issues/14704)
* [改進塊引用導出](https://github.com/siyuan-note/siyuan/issues/14710)
* [匯出 PDF 時頁面縮放下改進程式碼塊行號對齊](https://github.com/siyuan-note/siyuan/issues/14719)
...
* [點選大綱後遊標定位到塊末](https://github.com/siyuan-note/siyuan/issues/14725)
...
* [改進程式碼塊本地語言渲染優先權](https://github.com/siyuan-note/siyuan/issues/14767)
...
* [改進塊屬性更新的穩定性](https://github.com/siyuan-note/siyuan/issues/14797)
* [瀏覽器剪藏擴充支援範本配置](https://github.com/siyuan-note/siyuan/issues/14801)
* [改良末軟換行](https://github.com/siyuan-note/siyuan/issues/14807)

### 修復缺陷

* [行動端點擊影片會跳到遊標所在的塊](https://github.com/siyuan-note/siyuan/issues/14569)
* [程式碼塊中按 Delete 鍵時出現例外狀況](https://github.com/siyuan-note/siyuan/issues/14645)
...
* [塊級公式在預覽模式下無法渲染](https://github.com/siyuan-note/siyuan/issues/14671)
