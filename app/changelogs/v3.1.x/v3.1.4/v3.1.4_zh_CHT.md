...
* [插入帶有 `allow-popups` 屬性的 IFrame 塊](https://github.com/siyuan-note/siyuan/issues/12055)
...
* [改進刪除主題分隔線下方的空白塊](https://github.com/siyuan-note/siyuan/issues/12149)
* [在程式碼塊中按 Tab 鍵不再取消選取內容](https://github.com/siyuan-note/siyuan/issues/12174)
* [AI 操作 `清除上下文` 不再關閉彈出視窗](https://github.com/siyuan-note/siyuan/issues/12181)
* [改進 `Alt` 或 `Shift` 拖曳塊圖示](https://github.com/siyuan-note/siyuan/issues/12190)
...
* [清單項目斷線不再影響資料庫綁定塊](https://github.com/siyuan-note/siyuan/issues/12235)
...
* [`複製標題和底部塊` 在 Android 上無法正常運作](https://github.com/siyuan-note/siyuan/issues/12211)
...
* [更新程式碼塊的 DOM](https://github.com/siyuan-note/siyuan/issues/10769)
