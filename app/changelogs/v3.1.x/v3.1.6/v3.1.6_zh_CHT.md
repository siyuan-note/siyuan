...
* [改進資料庫主鍵欄位綁定塊](https://github.com/siyuan-note/siyuan/issues/12020)
...
* [`轉換為引用塊` 支援配置快速鍵](https://github.com/siyuan-note/siyuan/issues/12069)
...
* [改進程式碼塊 Ctrl+A 複製](https://github.com/siyuan-note/siyuan/issues/12129)
* [在同一塊引用多個塊後反向連結去重](https://github.com/siyuan-note/siyuan/issues/12147)
...
* [改進移動塊後引用關係更新](https://github.com/siyuan-note/siyuan/issues/12324)
* [為表格新增預設對齊](https://github.com/siyuan-note/siyuan/issues/12360)
* [改進程式碼塊行號計算](https://github.com/siyuan-note/siyuan/issues/12382)
...
* [右鍵點選公式塊可能會彈出錯誤的選單](https://github.com/siyuan-note/siyuan/issues/12292)
