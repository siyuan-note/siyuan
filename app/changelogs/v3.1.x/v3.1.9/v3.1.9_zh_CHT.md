...
* [改進在超級塊中按 Enter 鍵建立新塊](https://github.com/siyuan-note/siyuan/issues/10696)
...
* [支援 `Alt+拖曳` 文件樹上的文件到編輯器裡插入塊引用](https://github.com/siyuan-note/siyuan/issues/12482)
...
* [改進綁定容器塊的資料庫主鍵內容更新](https://github.com/siyuan-note/siyuan/issues/12664)
...
* [改進嵌入塊的標題層級匯出](https://github.com/siyuan-note/siyuan/issues/12741)
* [改進資料索引效能](https://github.com/siyuan-note/siyuan/issues/12777)

### 修復缺陷

* [無法在程式碼塊中替換 `&gt;`](https://github.com/siyuan-note/siyuan/issues/12660)
...
* [在行動端無法啟用「允許執行 HTML 塊內腳本」選項](https://github.com/siyuan-note/siyuan/issues/12744)
