...
* [在資料庫卡片檢視的預覽區域中新增「內容塊」選項](https://github.com/siyuan-note/siyuan/issues/15155)
* [改進插入塊引用後立即使用快速鍵開啟的體驗](https://github.com/siyuan-note/siyuan/issues/15208)
...
* [資料庫卡片檢視中綁定的標題塊在預覽區域顯示子塊](https://github.com/siyuan-note/siyuan/issues/15288)
* [改進移動容器塊後引用計數的更新](https://github.com/siyuan-note/siyuan/issues/15289)
* [改進轉換標題塊層級後引用計數的更新](https://github.com/siyuan-note/siyuan/issues/15298)
...
* [改進 HTML 程式碼塊剪輯](https://github.com/siyuan-note/siyuan/issues/15314)
* [改進將網路資源轉換為本地資源](https://github.com/siyuan-note/siyuan/issues/15320)
* [改進移動標題塊後引用計數的更新](https://github.com/siyuan-note/siyuan/issues/15322)
* [設定屬性後不再為塊元素新增 `id` 屬性](https://github.com/siyuan-note/siyuan/issues/15327)
...
* [選擇內容塊後 AI 操作無效](https://github.com/siyuan-note/siyuan/issues/15223)
...
* [複製塊時未複製屬性](https://github.com/siyuan-note/siyuan/issues/15268)
...
* [新增一些核心批次插入塊的 API](https://github.com/siyuan-note/siyuan/issues/15321)
