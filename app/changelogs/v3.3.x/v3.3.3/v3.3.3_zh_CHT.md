...
* [折疊標題後新建的塊為同級標題](https://github.com/siyuan-note/siyuan/issues/15725)
...
* [改進複製/剪下/刪除 `標題與下方塊` 選單](https://github.com/siyuan-note/siyuan/issues/15797)
...
* [改進 HTML 程式碼塊剪藏](https://github.com/siyuan-note/siyuan/issues/15855)
...
* [資料庫關聯欄位不允許編輯未綁定塊的圖示](https://github.com/siyuan-note/siyuan/issues/15859)
* [改進資料庫互動細節](https://github.com/siyuan-note/siyuan/issues/15861)
* [在程式碼塊開頭使用退格鍵時改進互動](https://github.com/siyuan-note/siyuan/issues/15864)
...
* [改進可編輯塊的判斷和 HTML 塊的轉義處理](https://github.com/siyuan-note/siyuan/issues/15904)
...
* [匯出圖片時程式碼塊行號顯示為 0](https://github.com/siyuan-note/siyuan/issues/15837)
* [檔案歷史無法載入資料庫塊的正確檢視](https://github.com/siyuan-note/siyuan/issues/15841)
* [程式碼塊包含 ``` 時「最佳化排版」異常](https://github.com/siyuan-note/siyuan/issues/15843)
