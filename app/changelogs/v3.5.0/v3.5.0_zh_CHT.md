...
* 更新後不支援回退：使用新版建立了包含提示塊的文檔，用舊版開啟會導致提示塊遺失
...
* [提示塊](https://github.com/siyuan-note/siyuan/issues/16051)

### 改進功能

* [改進備註提示](https://github.com/siyuan-note/siyuan/issues/14796)
* [改進打開塊的位置定位](https://github.com/siyuan-note/siyuan/issues/16477)
...
* [改進清單中 `跳到父塊` 的行為](https://github.com/siyuan-note/siyuan/issues/16516)
...
* [查詢嵌入塊支援 UNION 查詢](https://github.com/siyuan-note/siyuan/issues/16594)
...
* [修正嵌入塊匯出錯誤](https://github.com/siyuan-note/siyuan/issues/16547)
