...
export const PROVIDER_PRESETS: IProviderPreset[] = [
    ...
    {id: "api-route", name: "API Route", baseURL: "https://global.api-route.com/v1", category: "aggregator", responsesSupport: "supported", icon: "/stage/images/ai-providers/api-route.svg"},
