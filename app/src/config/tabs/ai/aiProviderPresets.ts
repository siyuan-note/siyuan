...
export const PROVIDER_PRESETS: IProviderPreset[] = [
    ...
    {id: "aimlapi", name: "aimlapi.com", baseURL: "https://api.aimlapi.com/v1", category: "aggregator", responsesSupport: "experimental", icon: "/stage/images/ai-providers/aimlapi.svg"},
