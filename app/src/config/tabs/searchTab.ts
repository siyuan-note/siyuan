...
const registerSearchQueryGroup = (tab: SettingTabBuilder) => {
    ...
    group.switchQuery({
        ...
        items: [
            ...
            {kind: "switch", id: "search.htmlBlock", label: window.siyuan.languages.htmlBlock, icon: "iconHTML5"},
            {kind: "switch", id: "search.databaseBlock", label: window.siyuan.languages.databaseBlock, icon: "iconDatabase"},
            {kind: "switch", id: "search.embedBlock", label: window.siyuan.languages.embedBlock, icon: "iconSQL"},
            {kind: "switch", id: "search.videoBlock", label: window.siyuan.languages.videoBlock, icon: "iconVideo"},
            {kind: "switch", id: "search.audioBlock", label: window.siyuan.languages.audioBlock, icon: "iconRecord"},
            {kind: "switch", id: "search.iframeBlock", label: window.siyuan.languages.iframeBlock, icon: "iconGlobe"},
            {kind: "switch", id: "search.widgetBlock", label: window.siyuan.languages.widgetBlock, icon: "iconBoth"},
            {kind: "switch", id: "search.blockquote", label: `${window.siyuan.languages.quote} <sup>[1]</sup>`, icon: "iconQuote"},
            {kind: "switch", id: "search.tabs", label: `${window.siyuan.languages.tabs} <sup>[1]</sup>`, icon: "iconTabs"},
            {kind: "switch", id: "search.tabItem", label: `${window.siyuan.languages.tabItem} <sup>[1]</sup>`, icon: "iconTabItem"},
            ...
            {kind: "switch", id: "search.document", label: window.siyuan.languages.documentBlock, icon: "iconFile"},
        ],
    });
    group.switchQuery({
        key: "blockAttr",
