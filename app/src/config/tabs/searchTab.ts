...
const registerSearchQueryGroup = (tab: SettingTabBuilder) => {
    ...
    group.switchQuery({
        ...
        items: [
            ...
            {kind: "switch", id: "search.tabs", label: window.siyuan.languages.tabs, icon: "iconTabs"},
            {kind: "switch", id: "search.tabItem", label: window.siyuan.languages.tabItem, icon: "iconTabItem"},
