...
<div class="b3-dialog__container${options.containerClassName ? ` ${options.containerClassName}` : ""}" style="width:${options.width || "auto"};height:${options.height || "auto"};left:${left};top:${top}">
