export const getMobileHintPosition = (anchorTop: number, anchorBottom: number, viewportTop: number,
                                      viewportBottom: number, heightLimit = Infinity,
                                      gap = 0) => {
    ...
    return {
        maxHeight,
        top: below ? visibleAnchorBottom + gap : viewportTop,
    };
};
