...
export const openInlineStyleDialog = (initialType: TInlineStyleType = "backgroundColor",
    ...
    const dialog = new Dialog({
        ...
        content: `<div class="b3-dialog__content" style="display:flex;flex-direction:column;gap:12px;max-height:70vh;overflow:auto">
    <div data-panel="list">
        <div data-type="inlineStyleList" class="b3-list b3-list--background fn__selectnone" style="--file-toggle-width:0px"></div>
        <button class="b3-button b3-button--outline" data-action="new" type="button" style="margin-top:8px">
    ...
    <div data-panel="editor" class="fn__none">
        ...
        <div class="fn__flex" style="align-items:stretch;gap:12px;flex-wrap:wrap">
            <div class="b3-label fn__flex-1" style="min-width:200px">
                <div>${window.siyuan.languages.themeLight}</div>
                <label class="fn__flex" data-property="color" style="margin-top:8px">
                    <span class="fn__flex-1">${window.siyuan.languages.colorFont}</span>
                    <input class="b3-text-field" data-field="lightColor" type="color">
                </label>
                <label class="fn__flex" data-property="backgroundColor" style="margin-top:8px">
        ...
        <div class="fn__flex" style="justify-content:flex-end;margin-top:12px">
            <button class="b3-button b3-button--cancel" data-action="cancelEdit" type="button">${window.siyuan.languages.cancel}</button>
            <span class="fn__space"></span>
            <button class="b3-button b3-button--text" data-action="confirmEdit" type="button">${window.siyuan.languages.confirm}</button>
        </div>
    </div>
</div>
<div class="b3-dialog__action" data-panel="actions">
    ...
    const actionsPanel = dialog.element.querySelector('[data-panel="actions"]') as HTMLElement;
    ...
    const renderList = () => {
        listElement.innerHTML = draft.styles.length === 0 ?
            `<div class="b3-list-item"><span class="b3-list-item__text">${window.siyuan.languages.empty}</span></div>` :
    ...
    const showList = () => {
        ...
        actionsPanel.classList.remove("fn__none");
        renderList();
    };
    ...
    const showEditor = (index?: number) => {
        ...
        actionsPanel.classList.add("fn__none");
