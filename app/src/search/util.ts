...
export const genSearch = (app: App, config: Config.IUILayoutTabSearchConfig, element: Element, closeCB?: () => void) => {
    ...
    <div class="search__tip${closeCB ? "" : " fn__none"}">
        ...
        <kbd>${updateHotkeyTip(window.siyuan.config.keymap.editor.general.insertRight.custom)}/${isMac() ? updateHotkeyTip("⌥") : updateHotkeyTip("⌥").replace("⌥", "Alt+")}${window.siyuan.languages.click}</kbd> ${window.siyuan.languages.searchTip4}
