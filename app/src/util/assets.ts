...
.protyle-gutters button svg {height:${height}px}`;
    if (window.siyuan.config.editor.fontFamily) {
        style += `\n.b3-typography:not(.b3-typography--default), .protyle-wysiwyg, .protyle-title {font-family: "Number Glyphs", "Segoe Good Emoji", "Other Emojis", "${window.siyuan.config.editor.fontFamily}", var(--b3-font-family-text)}`;
    }
    // pad 端菜单移除显示，如工作空间
