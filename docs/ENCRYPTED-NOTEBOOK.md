...
- The container starts with the fixed `SYAE` marker; name metadata and content chunks are authenticated separately with AAD binding the boxID, disk filename, and chunk index
