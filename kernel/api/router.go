...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/system/setUILayout", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setUILayout) // 这里不加鉴权 After modifying the access authentication code on the browser side, the other side does not refresh https://github.com/siyuan-note/siyuan/issues/8028
	...
	ginServer.Handle("POST", "/api/bazaar/getBazaarPackageREAME", model.CheckAuth, model.CheckAdminRole, getBazaarPackageREAME)
	ginServer.Handle("POST", "/api/bazaar/getUpdatedPackage", model.CheckAuth, getUpdatedPackage)
	ginServer.Handle("POST", "/api/bazaar/batchUpdatePackage", model.CheckAuth, model.CheckAdminRole, batchUpdatePackage)
	...
	ginServer.Handle("POST", "/api/av/searchAttributeView", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, searchAttributeView)
	ginServer.Handle("POST", "/api/av/getAttributeView", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, getAttributeView)
