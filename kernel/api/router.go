...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/av/searchAttributeView", model.CheckAuth, searchAttributeView)
	ginServer.Handle("POST", "/api/av/getAttributeView", model.CheckAuth, getAttributeView)
	ginServer.Handle("POST", "/api/av/searchAttributeViewRelationKey", model.CheckAuth, searchAttributeViewRelationKey)
	ginServer.Handle("POST", "/api/av/searchAttributeViewNonRelationKey", model.CheckAuth, searchAttributeViewNonRelationKey)
	...
	ginServer.Handle("POST", "/api/av/getAttributeViewPrimaryKeyValues", model.CheckAuth, getAttributeViewPrimaryKeyValues)
	...
	ginServer.Handle("POST", "/api/av/getMirrorDatabaseBlocks", model.CheckAuth, getMirrorDatabaseBlocks)
