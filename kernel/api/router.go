...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/filetree/setPublishVisible", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setPublishVisible)
	ginServer.Handle("POST", "/api/filetree/getPublishVisible", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, getPublishVisible)
