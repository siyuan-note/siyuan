...
var NotebookTool = &Tool{
	...
	InputSchema: ToolSchema{
		...
		Properties: map[string]Property{
			...
			"icon":   {Type: "string", Description: "Notebook icon (for set_icon). Emoji hex codepoint like \"1f4ca\", emoji character like \"📊\", custom image path like \"1/b3log.png\", network image URL like \"https://example.com/icon.png\", or dynamic icon URL like \"api/icon/getDynamicIcon?type=8&color=%23d23f31&content=Jitang%20Notes&id=xxx\""},
		},
